# ===============================================================
# 📈 LSTM + FinBERT Stock Market Predictor
# ===============================================================
...
# ===============================================================
# STEP 2: VISUALIZATION - CANDLESTICK & MOVING AVERAGES
# ===============================================================
...
# ===============================================================
# STEP 4: LSTM MODEL CREATION / LOADING
# ===============================================================
...
last_look = scaled_data[-look_back:]
predictions_future = []

for _ in range(future_days):
    X_test = np.array([last_look])
    X_test = np.reshape(X_test, (1, look_back, 1))
    pred_price = model.predict(X_test)
    predictions_future.append(pred_price[0][0])
    last_look = np.append(last_look[1:], pred_price[0][0])
    last_look = np.reshape(last_look, (look_back,))
...
if "predicted_future_prices" in locals():
    ...
    if st.button("Generate Summary Insight"):
        st.info(f"Based on recent trends, {ticker} shows a **{trend}** pattern with FinBERT sentiment leaning towards **{sentiment_labels[sentiment_index]}**.")
